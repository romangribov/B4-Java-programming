package io.loop.test.day33_a_static;

import java.util.Arrays;

// Import all the static members and reach them without class name
import static io.loop.test.day33_a_static.LoopcampStudent.*;
import static io.loop.test.day33_a_static.LoopcampStudent.printStaticInfo;
